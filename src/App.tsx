  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-[#050608]/85 backdrop-blur-xl border-b border-white/5">
      <div className="container mx-auto px-6 h-28 flex justify-between items-center">
        ...
        {/* MENÜ BAĞLANTILARI - ORTALANMIŞ VE HIZALANMIŞ */}
        <div className="hidden md:flex items-center gap-10">
          {['BAŞLANGIÇ', 'HİZMETLER', 'YAKLAŞIMIM'].map((item) => (
            <a 
              key={item} 
              href={`#${item.toLowerCase()}`} 
              className="text-[10px] font-black tracking-[0.4em] text-slate-500 hover:text-white transition-colors"
            >
              {item}
            </a>
          ))}
        ...
        {/* SAĞ TARAF: GÜVENLİ BAĞLANTI BUTONU */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              <span className="label-mono text-cyan-400 text-xs mb-4 block tracking-[0.4em] uppercase font-bold">MODERN WEB TASARIMCISI & STRATEJİST</span>
              <h1 className="text-5xl md:text-8xl font-black uppercase leading-[0.9] tracking-tighter mb-10 shadow-lg shadow-black/20">
